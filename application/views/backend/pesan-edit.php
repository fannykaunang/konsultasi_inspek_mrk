	...
	<div class="page">
		<div class="page-header">
			<ol class="breadcrumb">
				...
				<li><a href="<?= base_url(); ?>backend/news">Pesan Pelaporan</a></li>
							...
							<form class="form-horizontal" id="FormNewsEdit" name="FormNewsEdit">
									...
									<div class="col-md-9">
										...
										<div class="form-control no-line no-left-padding">
											<input type='checkbox' class="form-inline uniformcheckbox" id="FlagPublish"
												name="FlagPublish" <?= $FlagPublish; ?> 		<?= $disabled; ?> /> Teruskan Ke IRBAN
											&nbsp;
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										...
										&nbsp; &nbsp;
										<a href="<?= base_url(); ?>backend/pesan"><button type="button"
	...
	<script>
		...
		$(function () {
			...
			var MyTable = $("#MyTable").dataTable({
				...
				"bServerSide": true,
				"ajax": {
					"url": "<?= base_url(); ?>backend/pesan/GalleryList",
					"type": "POST",
					"data": {
									...
									$.ajax({
										...
										success: function (respon) {
											if (respon.status == 'sukses') {
												...
												setTimeout(function () { window.location = '<?= base_url(); ?>backend/pesan'; }, 1000);
											}
										},
										timeout: 20000,
										error: function () {
