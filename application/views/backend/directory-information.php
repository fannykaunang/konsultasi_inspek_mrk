...
<body class="site-menubar-unfold site-menubar-keep">
  ...
  <div class="page">
    <div class="page-header">
      ...
      <h1 class="page-title">Direktori Informasi</h1>
			 <div class="page-header-actions">
        <a href="<?=base_url();?>backend/directory_information/add" class="btn btn-sm btn-icon btn-inverse" data-toggle="tooltip"
        data-original-title="Halaman Baru" id="AddPage">
            ...
            <div class="widget-content padding-10 bg-green-600">
              ...
              <div class="counter counter-md counter-inverse text-left">
                <div class="counter-number-group">
                  ...
                  <span class="counter-number-related text-capitalize">direktori</span>
                </div>
 ...
 <script>
	...
	$(function(){
		...
		var MyTable = $("#MyTable").dataTable({
			...
			"bServerSide": true,			
			"ajax": {
				"url": "<?=base_url();?>backend/directory_information/DirectoryList",
				"type": "POST",
				"data":{
			...
			"columns": [				
				...
				{"data": 'TitleDirectory'}, 
				{"data": 'CategoryDirectory'},			
				{"data": 'AuthorDirectory'},
				{"data": 'FlagPublish'},
				{"data": 'Option'}
			],			
			"lengthMenu": [
	...
	//------------------------------------------------------------------------------------//
	function DirectoryDelete(IdDirectory){		
			bootbox.dialog({
