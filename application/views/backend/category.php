	...
	<div class="page">
		<div class="page-header">
			...
			<div class="page-header-actions">
				<button onclick="CategoryCreate();" class="btn btn-sm btn-icon btn-inverse" data-toggle="tooltip"
					<?= $RoleCategoryCreate; ?> data-original-title="Kategori Baru">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="NameCategory" id="NameCategory" placeholder="Nama kategori"
									class="form-control tooltip-right" title="Nama kategori" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Keterangan</label>
							<div class="col-sm-9">
								<textarea name="NoteCategory" id="NoteCategory" placeholder="Keterangan"
									class="form-control tooltip-right" title="Keterangan" /></textarea>
							</div>
						</div>
	...
	<script>
		...
		$(function () {
			...
			var MyTable = $("#MyTable").dataTable({
				...
				"bServerSide": true,
				"ajax": {
					"url": "<?= base_url(); ?>backend/category/CategoryList",
					"type": "POST",
					"data": {
				...
				"columnDefs": [
					...
					{ "orderable": false, "targets": 2, 'sClass': 'text-center' }
