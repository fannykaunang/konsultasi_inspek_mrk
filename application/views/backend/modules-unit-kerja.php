...
<body class="site-menubar-unfold site-menubar-keep">
  ...
  <div class="page animsition">
    <div class="page-header">
        ...
        <li class="active">Kategori Dokumen Unit kerja</li>
      </ol>
      <h1 class="page-title">Kategori Dokumen Unit kerja</h1>
				...
				<div class="modal-body">					
						...
						<form class="form-horizontal" name="FormCategoryCreate" id="FormCategoryCreate" method="POST">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control show-menu-arrow" name="NameCategory" id="NameCategory" data-plugin="selectpicker">
                                        <option value="" selected>-PILIH-</option>
                                        <?php
                                            foreach ($unit_kerja as $row) {
                                            ?>
                                                <option value="<?= $row->UnitKerja; ?>"><?= $row->UnitKerja; ?></option>
                                            <?php
                                            }
                                        ?>
                                    </select>
				...
				<div class="modal-body">
						...
						<form class="form-horizontal" name="FormCategoryEdit" id="FormCategoryEdit" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="NameCategory" id="NameCategory" placeholder="Nama kategori" class="form-control tooltip-right" title="Judul slide" readonly/>
									<!-- <select class="form-control show-menu-arrow" name="NameCategory" id="NameCategory" data-plugin="selectpicker">
                                        <option value="" selected>-PILIH-</option>
                                        <?php
                                            foreach ($unit_kerja as $row) {
 ...
 <script>
	...
	$(function(){
		...
		var MyTable = $("#MyTable").dataTable({
			...
			"bServerSide": true,			
			"ajax": {
				"url": "<?=base_url();?>backend/modules_unit_kerja/UnitKerjaCategoryList",
				"type": "POST",
				"data":{
