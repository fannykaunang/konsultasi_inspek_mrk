    ...
    <div class="page">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li><a href="<?= base_url(); ?>backend/sambutan">Sambutan</a></li>
                <li class="active">Edit Sambutan</li>
            </ol>
            <h1 class="page-title">Edit Sambutan Kepala Dinas</h1>
        </div>
                    ...
                    ?>
                                <form class="form-horizontal" id="FormPageSambutan" name="FormPageSambutan">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type='text' class="form-control" value="Penulis: <?= $authorpage; ?>, Terakhir update: <?= DateTimeIndo($row->TglUpdate); ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="ContentPage" class="col-md-2 control-label">Isi Sambutan</label>
                                        <div class="col-md-10">
                                            <textarea class="form-control" id="ContentPage" name="ContentPage" data-toggle="tooltip" title="Isi Sambutan" rows="10"><?= $row->Sambutan; ?></textarea>
                                        </div>
                                    </div>
                                    <input type="hidden" name="IDSambutan" id="IDSambutan" value="<?= $row->IDSambutan; ?>" />
        ...
        $(function() {
            ...
            $("#FormPageSambutan").submit(function(e) {
                ...
                if ($("#FormPageSambutan").valid()) {
                    //////////////////////
                    bootbox.dialog({
                        message: "Apakah anda yakin akan menyimpan sambutan ini?",
                        title: "Konfirmasi",
                        buttons: {
                            danger: {
                                label: "No",
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(respon) {
                                            if (respon.status == 'sukses') {
                                                ...
                                                setTimeout(function() {
                                                    window.location = '<?= base_url(); ?>backend/sambutan';
                                                }, 1000);
                                            }
                                        },
                                        timeout: 20000,
