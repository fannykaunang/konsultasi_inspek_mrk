...
<body class="site-menubar-unfold site-menubar-keep">
    ...
    <div class="page">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="active">Tupoksi Baru</li>
            </ol>
            <h1 class="page-title">Tupoksi Baru</h1>
        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12" id="AlertTupoksiCreate">
                        <div class="alert alert-success alert-dismissible" role="alert">
                            ...
                            Tupoksi berhasil disimpan, untuk melihat daftar Tupoksi klik <a class="alert-link" href="<?= base_url(); ?>backend/tupoksi" title="Daftar Tupoksi" data-toggle="tooltip">Tupoksi</a>.
                        </div>
                    </div>
                    <form class="form-horizontal" id="FormTupoksiCreate" name="FormTupoksiCreate">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" id="TugasPokok" name="TugasPokok" title="Tugas Pokok" data-toggle="tooltip" placeholder="Tugas Pokok"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Fungsi" class="col-md-2 control-label">Fungsi</label>
                            <div class="col-md-10">
                                <textarea class="form-control" id="Fungsi" name="Fungsi" data-toggle="tooltip" title="Fungsi" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        $(function() {
            //------------------------------------------------------------------------------------//
            $("#FormTupoksiCreate").find("#TugasPokok").focus();
            //------------------------------------------------------------------------------------//
            tinymce.init({
