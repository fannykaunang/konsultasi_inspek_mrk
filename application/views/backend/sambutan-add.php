    ...
    <div class="page">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="active">Sambutan Baru</li>
            </ol>
            <h1 class="page-title">Halaman Sambutan Baru</h1>
        </div>
                    ...
                    ?>
                        <div class="col-md-12" id="AlertPageCreate">
                            <div class="alert alert-success alert-dismissible" role="alert">
                                ...
                                Halaman berhasil disimpan, untuk melihat daftar Sambutan klik <a class="alert-link" href="<?= base_url(); ?>backend/sambutan" title="Daftar sambutan" data-toggle="tooltip">sambutan</a>.
                            </div>
                        </div>
                        <form class="form-horizontal" id="FormPageSambutan" name="FormPageSambutan">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" id="ContentPage" name="ContentPage" data-toggle="tooltip" title="Isi Sambutan" rows="10"></textarea>
                                </div>
                            </div>
