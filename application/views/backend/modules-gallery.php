	...
	<div class="page animsition">
		<div class="page-header">
			<ol class="breadcrumb">
				...
				<li class="active">Pengaturan Galeri</li>
			</ol>
			<h1 class="page-title">Galeri</h1>
			<div class="page-header-actions">
				<button class="btn btn-sm btn-icon btn-inverse" data-toggle="tooltip"
					data-original-title="Kategori/album baru" onclick="CategoryCreate();">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Kategori/album Baru</h4>
				</div>
				<div class="modal-body">
					...
					<form class="form-horizontal" name="FormCategoryCreate" id="FormCategoryCreate" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="NameCategory" id="NameCategory"
									placeholder="Nama kategori/album" class="form-control tooltip-right"
									title="Nama kategori" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="kategori" class="col-sm-3 control-label">Tipe</label>
							<div class="col-sm-5">
								<select class="form-control show-menu-arrow" data-plugin="selectpicker" name="MediaType"
									id="MediaType" data-toggle="tooltip" title="Tipe">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<div class="form-control no-line no-left-padding">
									<input type='checkbox' class="form-inline uniformcheckbox" autocomplete="off"
										id="FlagPublish" name="FlagPublish"> Publish &nbsp;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
							aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="myModalLabel">Update Kategori/album</h4>
				</div>
				<div class="modal-body">
	...
	<script>
		...
		$(function () {
			...
			var MyTable = $("#MyTable").dataTable({
				...
				"bServerSide": true,
				"ajax": {
					"url": "<?= base_url(); ?>backend/modules_gallery/CategoryList",
					"type": "POST",
					"data": {
