...
<body class="site-menubar-unfold site-menubar-keep">
  ...
  <div class="page">
    <div class="page-header">
        ...
        <li class="active">Kategori Halaman</li>
      </ol>
      <h1 class="page-title">Daftar Kategori Halaman</h1>
 ...
 <script>
	...
	$(function(){
		...
		var MyTable = $("#MyTable").dataTable({
			...
			"bServerSide": true,			
			"ajax": {
				"url": "<?=base_url();?>backend/category_page/CategoryList",
				"type": "POST",
				"data":{
					...
					buttons: {				
						...
						main: {
							...
							callback: function() {
									...
									$.ajax({
										url: '<?=base_url();?>backend/category_page/ajax',
										type: 'POST',
										dataType: 'json',
