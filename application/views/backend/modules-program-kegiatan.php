...
<body class="site-menubar-unfold site-menubar-keep">
  ...
  <div class="page animsition">
    <div class="page-header">
        ...
        <li class="active">Kategori Program kegiatan</li>
      </ol>
      <h1 class="page-title">Kategori Program Kegiatan</h1>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">					
						...
						<iframe name="IFrameUploadCategory" style="display:none;"></iframe>
						<form class="form-horizontal" name="FormCategoryCreate" id="FormCategoryCreate" method="POST" action="<?=base_url();?>backend/modules_program_kegiatan/UploadCategory" enctype="multipart/form-data" target="IFrameUploadCategory">
 ...
 <script>
	...
	$(function(){
		...
		var MyTable = $("#MyTable").dataTable({
			...
			"bServerSide": true,			
			"ajax": {
				"url": "<?=base_url();?>backend/modules_program_kegiatan/ProgramKegiatanCategoryList",
				"type": "POST",
				"data":{
		...
		$("#FormCategoryEdit").validate({			
			...
			messages: {
				NameCategory: {
					required: 'Nama kategory harus diisi'
				},
				Description: {
	...
	$('#FormCategoryCreate').submit(function(){
