...
<body class="site-menubar-unfold site-menubar-keep">
    ...
    <div class="page">
        <div class="page-header">
            ...
            <h1 class="page-title">Profil Dinas</h1>
            <div class="page-header-actions">
                <?php
                $displayButton = ($totalpage == 0 || $totalpage > 1) ? "display:inline-block" : "display:none";
                ?>
                <a href="<?= base_url(); ?>backend/profil_dinas/add" style="<?php echo $displayButton; ?>" class="btn btn-sm btn-icon btn-inverse" data-toggle="tooltip" data-original-title="Profil dinas Baru" id="AddSambutan">
    ...
    <script>
        ...
        $(function() {
            ...
            var MyTable = $("#MyTable").dataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "<?= base_url(); ?>backend/profil_dinas/SambutanList",
                    "type": "POST",
                    "data": {
        ...
        //------------------------------------------------------------------------------------//
        function PageDelete(IdProfil) {
            bootbox.dialog({
                message: "Anda yakin akan menghapus Profil ini?",
                title: "Konfirmasi",
                buttons: {
                    danger: {
                        label: "No",
