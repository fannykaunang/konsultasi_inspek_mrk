    ...
    <div class="page">
        <div class="page-header">
            ...
            <div class="page-header-actions">
                <?php
                $displayButton = ($totalunit == 6 || $totalunit > 7) ? "display:none" : "display:inline-block";
                ?>
                <a href="<?= base_url(); ?>backend/unit_kerja/add" style="<?= $displayButton; ?>"
                    class="btn btn-sm btn-icon btn-inverse" data-toggle="tooltip"
                    data-original-title="Tambah Unit kerja" id="AddNews">
                ...
                <div class="panel-body">
                    ...
                    <div class="list-group">
                        <a class="list-group-item" href="javascript:void(0)">
                            ...
                            <p class="list-group-item-text">Unit kerja sudah dipublish</p>
                        </a>
                        <a class="list-group-item" href="javascript:void(0)">
                            <h4 class="list-group-item-heading"><img
                                    src="<?= base_url(); ?>assets/backend/images/draft.png" /> Draft</h4>
                            <p class="list-group-item-text">Unit kerja masih draft</p>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            var MyTable = $("#MyTable").dataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "<?= base_url(); ?>backend/unit_kerja/TupoksiList",
                    "type": "POST",
                    "data": {
        ...
        //------------------------------------------------------------------------------------//
        function TupoksiDelete(IDUnit) {
            bootbox.dialog({
                message: "Anda yakin akan menghapus Unit kerja ini?",
                title: "Konfirmasi",
                buttons: {
                    danger: {
                        label: "No",
